...
class VideoParams(BaseModel):
    ...
    # Boş bırakılırsa video diline göre seçilir (app/services/fonts.py).
    # Sabit CJK varsayılanı Latin altyazılarda U+2019'u tam-genişlik çiziyor
    # ve Vietnamca'da hiç glif bulamıyordu.
